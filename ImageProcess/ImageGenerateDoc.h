...
public:
	...
	afx_msg void OnGenerateFillslategray();
	afx_msg void OnGenerateHorizontalgradient();
	afx_msg void OnGenerateVerticalbluegradient();
	afx_msg void OnGenerateDiagonalgradient();
